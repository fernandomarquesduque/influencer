...
export class RocksDBStorage {
  ...
  /**
   * Salva uma entidade (JSON do response) no bucket "profile" com key = entity.handle.
   */
  ...
  /**
   * Salva entidades de post (JSON) no bucket "post" com key = "profileHandle:shortcode".
   */
