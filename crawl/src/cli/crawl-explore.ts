...
import { runCrawlFromExplore } from '../crawl/runCrawl.js';
...
async function main(): Promise<void> {
  ...
  try {
    crawlLog('Iniciando crawl a partir do Explore (https://www.instagram.com/explore/)...');
    const result = await runCrawlFromExplore({ limit, clear }, storage);
