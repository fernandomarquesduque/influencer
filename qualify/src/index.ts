...
function buildRepairPrompt(originalPrompt: string, invalidJson: JsonRecord, errors: string[]): string {
  return [
    ...
    '- textos humanos (personaSummary, categorias etc.) em pt-BR; qualification.language: pt-br/en/es/uk/ru/desconhecido conforme a bio; nunca pt-br com bio cirilica ou so ingles/ucraniano',
    '- nao explique nada',
    '',
    'Prompt original:',
    originalPrompt,
...
function buildPrompt(
  ...
  return [
    ...
    'language: tag BCP-47 minuscula do idioma em que a bio foi ESCRITA (alfabeto/endereco/horario contam). pt-br SO se houver portugues claro; cirilico ou Ucrania/Lviv/.ua -> uk ou desconhecido; ingles na bio -> en. Nunca assuma pt-br pelo mercado BR.',
    ...
    '    "language": "pt-br|en|es|uk|ru|desconhecido",',
